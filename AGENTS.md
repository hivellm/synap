...
Generated at: 2026-04-07T22:48:08.470Z
...
For comprehensive Rust-specific guidelines, see `/.rulebook/specs/RUST.md`
...
| Languages | Rust | Execute these commands after EVERY implementation (see AGENT_AUTOMATION module for full workflow). |
...
> **Project context**: Primary language is **rust**. Agents are pre-configured with this context.
