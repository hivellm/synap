...
#
# Usage:
#   ./scripts/docker/docker-publish.sh [version] [--no-build] [--no-push] [--no-cache]
#
# Examples:
#   ./scripts/docker/docker-publish.sh           # Build and push latest
#   ./scripts/docker/docker-publish.sh 1.0.0      # Build and push specific version
#   ./scripts/docker/docker-publish.sh 1.0.0 --no-build  # Only push (skip build)
#   ./scripts/docker/docker-publish.sh 1.0.0 --no-push   # Only build (skip push)
#   ./scripts/docker/docker-publish.sh 1.0.0 --no-cache  # Cold build (ignore registry cache)
#
