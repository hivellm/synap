...
server and every Synap client still agree on the wire — including the two SDKs
with no Thunder package (PHP, Java) and any pre-Thunder client still deployed.
