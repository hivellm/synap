...
#   ./scripts/docker-publish.sh 0.8.1      # Build and push specific version
#   ./scripts/docker-publish.sh 0.8.1 --no-build  # Only push (skip build)
#   ./scripts/docker-publish.sh 0.8.1 --no-push   # Only build (skip push)
#
# Requirements:
